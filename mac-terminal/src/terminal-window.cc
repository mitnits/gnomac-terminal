...
/* See bug #789356 and issue gnomac-terminal#129*/
...
terminal_window_init (TerminalWindow *window)
{
  ...
  if (terminal_app_get_ask_default_terminal(app)) {
    ...
    auto const question = gtk_label_new (_("Set GnomacTerminal as your default terminal?"));
  ...
  g_snprintf (role, sizeof (role), "gnomac-terminal-window-%s", uuidstr);
...
terminal_window_class_init (TerminalWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/gnomac-terminal/ui/window.ui");
                            ...
                            guint32 timestamp)
{
  /* Load the UI */
  gs_unref_object GMenu *menu;
  terminal_util_load_objects_resource ("/org/gnome/gnomac-terminal/ui/notebook-menu.ui",
                                       "notebook-popup", &menu,
                                       nullptr);
