...
#define GNOMAC_TERMINAL_PREFERENCES_ICON_NAME    "org.gnome.GnomacTerminal.Preferences"
 ...
 * these categories. See gnomac-terminal 1.x for why.
 */
...
terminal_app_check_default(TerminalApp* app)
{
  ...
  // Check whether gnomac-terminal is the default terminal
                             ...
                             gboolean shell_shows_menubar)
{
  ...
  terminal_util_load_objects_resource (shell_shows_menubar ? "/org/gnome/gnomac-terminal/ui/menubar-without-mnemonics.ui"
                                                           : "/org/gnome/gnomac-terminal/ui/menubar-with-mnemonics.ui",
                                       "menubar", &app->menubar,
...
{
  terminal_util_load_objects_resource ("/org/gnome/gnomac-terminal/ui/headerbar-menu.ui",
...
terminal_app_startup (GApplication *application)
{
  ...
  gdk_set_program_class("Gnomac-terminal");
#elif defined(TERMINAL_PREFERENCES)
  gdk_set_program_class("Gnomac-terminal-preferences");
#else
#error
#endif
...
#if defined(TERMINAL_SERVER)
  gtk_window_set_default_icon_name (GNOMAC_TERMINAL_ICON_NAME);
#elif defined(TERMINAL_PREFERENCES)
  gtk_window_set_default_icon_name(GNOMAC_TERMINAL_PREFERENCES_ICON_NAME);
#else
#error
#endif
 ...
 * @app: a #TerminalApp
 *
 * Returns: (tranfer none): the cached #GSettings object for the org.gnome.GnomacTerminal.Preferences schema
 */
GSettings *
