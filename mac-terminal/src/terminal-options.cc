...
{
  terminal_printerr (_("Option “%s” is deprecated and might be removed in a later version of gnomac-terminal."),
                     option_name);
  terminal_printerr ("\n");
}
...
unsupported_option_callback (const gchar *option_name,
                             ...
                             GError     **error)
{
  terminal_printerr (_("Option “%s” is no longer supported in this version of gnomac-terminal."),
              option_name);
  terminal_printerr ("\n");
                                   ...
                                   GError     **error)
{
  g_set_error (error, G_OPTION_ERROR, G_OPTION_ERROR_UNKNOWN_OPTION,
               _("Option “%s” is no longer supported in this version of gnomac-terminal."),
               option_name);
  return FALSE;
}
...
option_version_cb (const gchar *option_name,
                   ...
                   GError     **error)
{
  terminal_print ("GnomacTerminal %s using VTE %u.%u.%u %s\n",
                  VERSION,
                        ...
                        GError **error)
{
  ...
  /* Collect info from gnomac-terminal private env vars */
...
get_goption_context (TerminalOptions *options)
{
  ...
  group = g_option_group_new ("gnomac-terminal",
                              N_("GnomacTerminal Emulator"),
                              N_("Show GnomacTerminal options"),
                              options,
                              nullptr);
